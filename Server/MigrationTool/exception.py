...
from MigrationTool.i18n import _, _LE
...
class MigrationToolException(Exception):
    ...
    def __init__(self, message=None, **kwargs):
        ...
        self.msg = message
        super(MigrationToolException, self).__init__(message)
...
class NotAuthorized(MigrationToolException):
...
class Invalid(MigrationToolException):
...
class APIException(MigrationToolException):
...
class NotFound(MigrationToolException):
...
class Duplicate(MigrationToolException):
    pass


class MalformedRequestBody(MigrationToolException):
...
class NoValidHost(MigrationToolException):
...
class TaskProcessException(MigrationToolException):
    pass
