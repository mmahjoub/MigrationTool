...
from MigrationTool.api import wsgi
from MigrationTool import context
from MigrationTool.i18n import _

LOG = logging.getLogger(__name__)


class MigrationToolKeystoneContext(wsgi.Middleware):
    ...
    def __call__(self, req):
        ...
        req.environ['MigrationTool.context'] = ctx
